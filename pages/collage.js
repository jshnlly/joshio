            ...
            >
                ...
                >
                    <video autoPlay loop muted playsInline className={styles.workVideo}>
                        <source src="/videos/collage.mp4" type="video/mp4" />
                    </video>
                ...
                <motion.div variants={itemVariants} className={styles.navContainer}>
                    <div className={styles.navLeftWork}> 
                        <p>with Jeremy Stewart and Dom Han</p>
                    </div>

                    <div className={styles.navRight}>
                        <p>
                            <a href="https://www.theverge.com/2024/12/16/24322563/instagram-recap-2024-collage-story" target="_blank" rel="noreferrer" className={styles.mainLinkText}>
                                The Verge
                            </a>
                        </p>
