            ...
            >
                ...
                >
                    <video autoPlay loop muted playsInline className={styles.workVideo}>
                        <source src="/videos/N!S.mp4" type="video/mp4" />
                    </video>
                ...
                >
                    <video autoPlay loop muted playsInline className={styles.workVideo}>
                        <source src="/videos/Polaroid Sticker.mp4" type="video/mp4" />
                    </video>
                ...
                >
                    <video autoPlay loop muted playsInline className={styles.workVideo}>
                        <source src="/videos/Reveal Sticker.mp4" type="video/mp4" />
                    </video>
                ...
                <motion.div variants={itemVariants} className={styles.navContainer}>
                    ...
                    <div className={styles.navRight}>
                        <p>
                            <a href="https://www.theverge.com/2024/5/3/24147991/instagram-stories-stickers-polaroid-frames-reveal" target="_blank" rel="noreferrer" className={styles.mainLinkText}>
                                The Verge
                            </a>
                            ,&nbsp;
                            <a href="https://www.instagram.com/p/C6gu6DFuoI6/?igsh=MXB6NzgxNGphdzJ5aQ==" target="_blank" rel="noreferrer" className={styles.mainLinkText}>
                                Launch Post
                            </a>
                        </p>
