            ...
            >
                ...
                >
                    <video autoPlay loop muted playsInline className={styles.workVideo}>
                        <source src="/videos/Candid Story.mp4" type="video/mp4" />
                    </video>
                ...
                <motion.div variants={itemVariants} className={styles.navContainer}>
                    <div className={styles.navLeftWork}> 
                        <p>with Vivian Wang</p>
                    </div>

                    <div className={styles.navRight}>
                        <p>
                            <a href="https://www.wsj.com/articles/instagram-challenges-bereal-and-adds-notes-short-message-feature-11670945979" target="_blank" rel="noreferrer" className={styles.mainLinkText}>
                                Wall Street Journal
                            </a>
                        </p>
